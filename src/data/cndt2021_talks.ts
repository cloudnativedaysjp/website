...
export const CNDT2021Talks: Talk[] = [
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1181/playlist.m3u8',
    title: 'Kubernetesネットワーキング初級者脱出ガイド -基本から最新動向まで-',
    abstract:
      'Kubernetesの仕組みを理解する上でネットワークの部分は忘れることができない要素です。しかし、オンプレ・パブリッククラウドなどで活用されるKubernetesでネットワークがどのような仕組みで実現されているかを包括的・詳細に説明された日本語の資料は今までありませんでした。\r\n今回はCNCFアンバサダーである太田から、Kubernetes初級者を脱出するために必要なネットワークの知識や、パブリッククラウドやアップストリームのKubernetesで利用可能なさまざまな仕組みや、アップストリームでの取り組みについて基本から解説します。',
    speakers: [
      {
        id: 1140,
        name: 'Kohei Ota',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/inductor/kubernetes-networking-beginners-guide',
    conferenceDayId: 11,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1183/1183.m3u8',
    title:
      '「DevSecOpsとは？」の一歩先、複数の導入経験から語るセキュリティエンジニアの本音',
    abstract:
      'DevSecOpsという言葉は、その実例の少なさと反して、聞く機会は多いではないでしょうか。「DevSecOpsとは？」を概念上は知っていても、具体的に何から取り組めばいいのか、どんな構成があるのか、分かっている方は多くはないと思います。複数のクライアントへの導入経験を元にしたDevSecOpsに関する本音から、アプローチ、導入後に必ずつまずくところ等、ご紹介できたらと思います。',
    speakers: [
      {
        id: 1142,
        name: 'Masaya Tahara',
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/MasayaTahara/devsecops-cloudnative-days-tokyo-2021',
    conferenceDayId: 11,
    conferenceDayDate: '2021-11-04',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1184/1184.m3u8',
    title: '自作して学ぶKubernetes scheduler入門',
    abstract:
      'Kubernetesのコンポーネントの内、PodをどのNodeで起動するかという事を決定するschedulerというものが存在します。このトークでは実際に動作する小規模なschedulerを段階的に実装していく様子から、schedulerはどのようにPodをスケジューリングしているのか、どのように拡張性を提供しているのか等を内部実装の理解を通して学んでいきます。対象者は、(簡単にでも)Kubernetesの使用をした経験のある方としますが、schedulerに関する知識は不問です。',
    speakers: [
      {
        id: 1143,
        name: 'Kensei Nakada',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1186/1186.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1189/1189.m3u8',
    title: '安心・安全なCluster移行で実現するKubernetesのバージョンアップ',
    abstract:
      'Kubernetesのバージョンアップの方法はいくつかありますが、我々のチームはCluster移行を選択しました。Cluster移行には運用上のメリットがある一方、考慮しなければいけないポイントもあります。本講演では、何故Cluster移行を選択したのか、またCluster移行時に生じる課題をどのような仕組みで解決しようとしているかについてお話したいと思います。',
    speakers: [
      {
        id: 1149,
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/sshirayama/kubernetes-upgrade-with-cluster-migration',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  {
    ...
    videoId: '',
    title:
      '【中止】The Twelve-Factor App in Modern Age - Cloudネイティブ時代に生きるHerokuの哲学',
    abstract:
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1192/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1196/1196.m3u8',
    title: '「Small is beautiful 」 KubernetesにUnixの哲学を ~ Carvelの紹介 ~',
    abstract:
      'Kubernetesのエコシステムが拡大にするに伴い、様々なツールが氾濫しています。高機能すぎるOSSや機能の重複に伴い、検証や比較に時間をとられすぎてしまい悩んでいないでしょうか？そんな中、Small is beautifulというUnixの哲学をもとに作られたOSS群Carvelが登場しました。あくまで一つの事柄に特化しそれを上手にやる、これに長けたOSS群であり、GitOpsや継続的デプロイメントを支援するツールが数多く登場しています。\r\n\r\nCarvelが既存のHelmやArgoCDといったツールと何がちがうか？その魅力をこのセッションで紹介します。',
    speakers: [
      {
        id: 1154,
        name: 'Machi Hoshino',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1198/1198.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/liubin/kata-containers-secure-container-beyond-secure',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1201/1201.m3u8',
    title: 'クラウドネイティブが強み！イマドキの銀行システムの姿',
    abstract:
      '今年５月に開業したみんなの銀行。我々が目指す先は、宇宙一お客様のことを考える銀行であり、そもそも今の時代において、『銀行って何？』から再定義することを目的として設立しました。システムも従来の重厚長大なシステムに捕らわれず、「今の時代」に最適な組み合わせを選択した結果、フルクラウド銀行システムが誕生しました。その姿と今後の組織の展望をお話しします。',
    speakers: [
      {
        id: 1159,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1202/1202.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/ysakashita/sutetohuruapuri-on-kubernetesfalsexian-zai-tojin-hou-falsezhan-wang',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1203/1203.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1204/1204.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1206/playlist.m3u8',
    title: 'クラウド時代のアプリケーションログ埋め込みと活用法',
    abstract:
      'クラウド上のバックエンドアプリケーションの開発者を対象に、リリース後のトラブルシューティングで泣かないための、アプリケーションログの埋め込みと検索について解説します。また実運用での事例についても紹介します。',
    speakers: [
      {
        id: 1164,
        name: 'Hideo Fukumori',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1207/1207.m3u8',
    title: 'Kubernetesオペレータのアンチパターン＆ベストプラクティス',
    abstract:
      'サイボウズではMOCO（MySQLオペレータ）やTopLVM（CSIプラグイン）をはじめとする数多くのカスタムコントローラやオペレータを開発し、RookやVictoriaMetrics Operator, ECKなどサードパーティ製のオペレータを含め、本番環境で運用しています。\r\nそれらの開発や運用の中で様々な問題に直面し、安定運用の維持に必要な対応をおこなってきました。\r\n本発表ではこれまでの経験からチームが学んだKubernetesオペレータのアンチパターンとベストプラクティスを紹介します。',
    speakers: [
      {
        id: 1165,
        name: 'Akihiro Ikezoe',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1208/1208.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1209/1209.m3u8',
    title:
      'KubeCon NAの振り返りー最新のクラウドネイティブ界隈の状況をお伝えします。',
    abstract:
      '10月に行われたKubeCon NAに現地で取材した情報を共有したいと思います。可能であれば複数人でラウンドテーブル的な座談会にできればと思います。',
    speakers: [
      {
        id: 1170,
    ...
    onAir: false,
    documentUrl:
      'https://docs.google.com/presentation/d/1nIYBM4vHxG8Mq4Ju4BsEu6uN4ZaOcqphSljZJhpZ7x0/edit?usp=sharing',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1210/1210.m3u8',
    title:
      'Kubernetes Cost Optimization（知っておきたいコンテナコスト最適化技術）',
    abstract:
      '大規模な業務システムでもKubernetesを活用したコンテナ基盤を運用する事例が増えてきました。Kubernetesをうまく活用することで、クラウドネイティブな開発手法を取り入れつつ柔軟なインフラ構成を取ることで、システム要件に応じたコスト削減が実現できます。ただし、アプリケーションを安定稼働させつつコンピューティングリソースを最適化するためには、Kubernetesのしくみだけでなく、アプリケーション観点での考慮事項やクラウドの提供機能についても把握する必要があります。\r\n\r\n本セッションでは、Kubernetesを活用したシステムのコストを最適化するポイントとして大規模映像解析ソリューション「Vision Data+」の開発を通して得たNode Pool/HPA/Cluster Autoscaler/Spot Instance/Pod Disruption Budget/KEDAや、リソース/コストの監視・ガバナンスとポリシー設定など、気になるコンテナコスト最適化のあれこれをご紹介します。 ',
    speakers: [
      {
        id: 1166,
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/shihoasa/kubernetes-cost-optimization',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1212/1212.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1242/playlist.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/nttdata-tech/cloud-native-waterfall-development-cndt2021-nttdata',
    conferenceDayId: 11,
    conferenceDayDate: '2021-11-04',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/shanpu/ciliumniyorukubernetes-network-policyfalseshi-xian-cndt2021',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1245/1245.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1250/1250.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1251/1251.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/tobachi/if-you-are-facing-the-complexity-of-cloud-native',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1253/playlist.m3u8',
    title: '故障・並行実行への耐性を備えるマイクロサービストランザクション',
    abstract:
      'マイクロサービスで分散トランザクションを実現する場合、単純にSagaを適用して補償トランザクションを実行する以上に検討しなければいけないことがあります。\r\n本セッションでは、そもそも分散トランザクションが必要となった背景である、「分散環境の不整合」と、その原因となる故障・並行実行の理論に着目します。\r\nそして、そこから導き出される、マイクロサービスが備えるべき、機能・検討項目を紹介します。',
    speakers: [
      {
        id: 1188,
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/polar3130/design-and-operations-of-gke-and-anthos-service-mesh-for-enterprises',
    conferenceDayId: 11,
    conferenceDayDate: '2021-11-04',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1256/1256.m3u8',
    title: 'EC2で稼働していたRailsアプリをECSに移行した話',
    abstract:
      '2020年にEC2で稼働していたRailsアプリケーションをコンテナ化、Amazon ECSに移行して現在は運用フェーズに入っています。コンテナ管理、デプロイパイプライン、スケジュール実行、作業用コンテナなどの要素を中心に技術選定、設計、実装の観点からAWSにおけるコンテナ移行の知見を共有します。また、実際に運用して見えてきた課題、その解決策についてもお話します。',
    speakers: [
      {
        id: 1190,
        name: 'Hitoshi Fujita',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1257/1257.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1258/1258.m3u8',
    title: 'マイクロサービスにおける分散トランザクションライブラリ',
    abstract:
      'マイクロサービスアーキテクチャにおいてマイクロサービス間のデータの整合性を保証するには、Sagaパターン等を用いる方法および分散トランザクションを用いる等の方法があります。本講演では、分散トランザクションを用いる方法の一つとして、Scalar DBと呼ばれるライブラリを用いて行う方法について、その仕組みや使い方を説明します。',
    speakers: [
      {
        id: 1183,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1259/1259.m3u8',
    title:
      'カオスエンジニアリングによる高信頼を目指して〜クレジットカード会社がChaosMeshを使ってみて',
    abstract:
      'JCBではお客様に価値あるサービスを迅速に提供するため、Kubernetesをはじめとするクラウドネイティブ技術を用いたアジャイル開発を行っています。その一つとして昨今改めて注目を集めるカオスエンジニアリングによる信頼性向上にも取り組んでいます。本発表ではJCBがカオスエンジニアリングに取り組むに至った背景や、ChaosMeshを使ってみた知見をご紹介します。',
    speakers: [
      {
        id: 1192,
        name: 'Yuki Naganuma',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/yu2kin9/kaosuenziniaringuniyorugao-xin-lai-womu-zhi-site-kurezitutokadohui-she-gachaosmeshwoshi-tutemite',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1260/1260.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1261/1261.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://drive.google.com/file/d/13WkkK3PCWD3OrNJ-ltOUfg9mEDb03W81/view?usp=sharing',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1264/1264.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1265/1265.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1272/1272.m3u8',
    title: '使いこなせ！Argo Workflows',
    abstract:
      'Argo Workflows を使えば Kubernetes 上でパイプライン処理を手軽に構築することが可能です。本セッションでは Argo Workflows の基本的な使い方から設定すべきポイントまでを個人的な視点で解説します。また Argo Events と組み合わせた構築例も紹介し、少し複雑なケースでの Argo Workflows の使い方も解説します。',
    speakers: [
      {
        id: 1204,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1275/1275.m3u8',
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1276/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1279/1279.m3u8',
    title: 'クラウドを最大限活用するInfrastructure as Codeを考えよう',
    abstract:
      '本セッションでは、Terraform、Pulumi、Kustomize、CrossplaneなどといったInfrastructure as Codeを取り巻くエコシステムを分析し、パブリッククラウドやKubernetesの力を最大限に引き出すためのツールスタックをどう組み上げていくか考察します。\r\nさらに、NTTコミュニケーションズがいくつもの本番環境で実践してきたCUE言語を使った新しい形のInfrastructure as Codeをデモンストレーションいたします。',
    speakers: [
      {
        id: 1210,
        name: 'Jun Makishi',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1280/1280.m3u8',
    title: 'クラウドネイティブって？',
    abstract:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1281/1281.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1282/1282.m3u8',
    title: 'スタンバイにおけるECS on FargateからEKS on Fargateへ移行した話',
    abstract:
      '株式会社スタンバイでは、2021年5月から求人検索エンジン「スタンバイ」をEKS on Fargateへ移行するプロジェクトを進めてきました。\r\nその第一弾として一部のサービスから移行をしています。\r\nこの講演では、移行の計画、EKS on Fargateを選んだ理由、既存システムとの結合、切替方法、今後の展望などについて共有します。',
    speakers: [
      {
        id: 1215,
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/stanby_inc/sutanbainiokeruecs-on-fargatekara-eks-on-fargateheyi-xing-sitahua',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1283/1283.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1284/1284.m3u8',
    title: 'コンテナネイティブストレージ Portworxの最新情報',
    abstract:
      '2020年9月に発表された Pure Storage による Kubernetes 向けデータ統合プラットフォームである Portworx 買収は、Pure Storage にとって過去最大の買収となりました。Portworxは、米国・欧州を中心に既に100社以上の採用実績（内８０％以上が既に本番環境で運用中）を持ち、ミッションクリティカルな環境でお使い頂いております。本セッションでは、どのように大規模ミッションクリティカルなコンテナステートフル環境が実現可能か、Portworxの最新情報と合わせてご紹介させて頂きます。',
    speakers: [
      {
        id: 1217,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1285/1285.m3u8',
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1287/playlist.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/kumashun/practical-canary-release-by-argo-cd-and-rollouts',
    conferenceDayId: 12,
    conferenceDayDate: '2021-11-05',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1289/1289.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1290/1290.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1291/1291.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1293/1293.m3u8',
    title: 'NTTデータ流 エンタープライズにおけるクラウド活用の姿',
    abstract:
      'NTTデータの主たる顧客層であるミッションクリティカルなエンタープライズ領域でも、クラウドやクラウドネイティブ技術の活用は急速に進んでいます。こういったミッションクリティカル・エンタプライズ領域においては、新規技術へのチャレンジと共に、厳しい非機能やレガシー対応といった課題にも直面します。\r\n本セッションでは、この両面の課題解決に向け、NTTデータにおいて取り組んでいるクラウド推進のための標準化・技術検証・人材育成の取組について紹介します。',
    speakers: [
      {
        id: 1227,
  ...
  },
  {
    ...
    abstract:
      'CircleCIは2021年に入ってからすでに60以上もの更新を重ね、またCD領域ではvamp社の買収を行いました。リクエストにお答えするための更新、CircleCIとしてCI/CDの未来像をこう考えているという更新。今後、どういった要素を自動化に取り込むことで、開発、運用、ビジネスに貢献しうるのかを「新機能」から紐解きます。',
    speakers: [
      {
        id: 1222,
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1295/1295.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1296/1296.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1298/1298.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1300/1300.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1301/playlist.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: 's3',
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1303_new/1303.m3u8',
    title:
      'シングルテナント・マルチクラスタ vs マルチテナント・シングルクラスタ論争 決着のとき',
    abstract:
      'シングルテナント・マルチクラスタか、マルチテナント・シングルクラスタか。 Kubernetes を最大限効果的に活用するにはマルチテナントが最善ですが、プロダクション環境をマルチテナントクラスタで実現するには多くの超えるべきハードルがありました。最適なマルチテナント環境のために何が必要だったのか解説するとともに、Sysdig Secure DevOps Platform を活用したコンテナ・セキュリティに対する取り組みについてもご紹介します。 \r\nーーーーーーーーーーーーーーーーーーーーーーー\r\n※本講演はSCSK株式会社によるスポンサー・セッションとなります',
    speakers: [
      {
        id: 1234,
    ...
    onAir: false,
    documentUrl:
      'https://drive.google.com/file/d/1ewzUXVdTE13YZdSifFET7huxEMk1nxC6/view?usp=sharing',
    conferenceDayId: 11,
    conferenceDayDate: '2021-11-04',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1304/1304.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://www.synopsys.com/ja-jp/software-integrity/em/20211104_CloudNativeDays.html',
    conferenceDayId: 11,
    conferenceDayDate: '2021-11-04',
    presentationMethod: null,
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1306/1306.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1307/1307.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2021/talks/1316/1316.m3u8',
    title:
      'APIサービスコネクティビティプラットフォームの衝撃！Kongを活用してAPIとマイクロサービスを容易かつ高速に活用しましょう',
    abstract:
      '最近の新聞記事では、オープンAPIなどの取り組みにおいて海外と比べて国内の取り組みの遅れやガラパゴス化についての指摘があります。グローバル企業における最新のIT活用を推進しIT市場をより活性化しているAPIの取り組みにおいて、Kongの技術がどのようにお客さまのお役に立てるか、についてお届けします。',
    speakers: [
      {
        id: 1240,
