...
export const CNDO2021Talks: Talk[] = [
  {
    ...
    abstract:
      'Container/k8s生活をパブリッククラウドのマネージドサービス(AWS ECS、EKSなど)で始める人達が多い昨今、スモールスタートな世界でセキュリティ対策を考えた場合、多機能で包括的なセキュリティ有償製品は導入コストの敷居が高い。\r\nとはいえ、パブリッククラウドのマネージドなセキュリティ対策機能だけでは不足感が否めない。その為、CNCFエコシステムなOSSツールを利用したセキュリティ対策の取り組みを共有します。',
    speakers: [
      {
        id: 121,
        name: '秋葉 洋毅',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/hiropinponpan/container-kubernetesfalsesekiyuriteidui-ce-wogai-metekao-eru',
    conferenceDayId: 7,
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/ssuserbeb7c0/cloudnative-days-spring-2021-online-keycloak',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'Apache Camel(以降、Camel)は、異種システムの連携ツールとして知られていますが、APIゲートウェイに必要な機能がすべてそろっており、またカスタマイズ性が高いため、特殊な要件を持つAPIゲートウェイに適していると考えています。そのため、我々はCamelをAPIゲートウェイとして用いつつ、OAuth 2.0の認可サーバとしても使用可能なKeycloakと組み合わせてAPI管理基盤を実現しました。Camelを用いたAPI管理基盤は、プロトコル変換、マッシュアップなどの特殊な要件に対応できます。また付随して、高度なアクセス制御やAPI仕様公開、統計情報提供なども可能になります。さらに、開発用GUIが提供されているため、ローコード開発も可能になります。',
    speakers: [
      {
        id: 161,
        name: '謝　洋',
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/ssuserbeb7c0/cloudnative-days-spring-2021-online-apache-camelkeycloakapi',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/saik1010/cndo2021-awschu-xue-zhe-gashi-merukontenawoli-yong-sitasabagou-zhu-ecs-fargate',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/zoetrope/onpurekubernetesdemysqlkurasutafalseyun-yong-wozi-dong-hua-surutamenioperatorwozi-zuo-siteiruhua',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/matsu1235/how-to-make-the-helm-operator-f0d3d746-486b-4103-b0b0-3d7a86a0b690',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    videoId: '521006657',
    title:
      'Kubernetesなんて知りたくなかった。ただ楽してアプリを作りたかっただけなんだ。',
    abstract:
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/ueokande/sloce-ding-toaratoshe-ding-madefalsechang-idao-falseri',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    videoId: '521011227',
    title:
      'EKS, AKS, GKEそしてオンプレミスのKubernetesをGUIで一元管理してみる話',
    abstract:
      'OSSのLensを使ってMultiクラスタ、Hybrid クラウドのKubernetesを簡単に管理する方法、注意事項などをお話しします。',
    speakers: [
      {
        id: 251,
        name: '嘉門延親',
  ...
  },
  {
    ...
    abstract:
      'あなたのkubeconfigはちゃんとユーザー認証していますか？KubernetesのAPI実行の際、頭を悩ませるのが、ログインを伴ったユーザー認証をどうやって実装するのかです。昨年11月にVMwareはこの問題をシンプルに解決できるPinnipedというOSSをリリースしました。このセッションでは、Pinnipedを紹介させていただくLightningTalkです。',
    speakers: [
      {
        id: 261,
        name: '星野 真知',
  ...
  },
  {
    ...
    abstract:
      'エンタープライズのインフラ構築・運用においても、ソースコードを中心にインフラを管理することの重要性は日々高まっています。ソースコード中心の管理には、ベスト・プラクティスである DevOps の文化・プロセス・ツール群を活用することが重要です。DevOps は Dev（開発）と Ops（運用）の対立解消を目的に、情報共有を促進し、相互理解・相互尊重に価値を置く概念です。エンタープライズのシステムでは、エンジニア系以外にも、非技術系のステークホルダーが数多く存在します。DevOps はエンジニアだけでなく、非技術系のステークホルダーも巻き込んで活用出来ると得られる価値がさらに増大し、チーム力の強化につながります。',
    speakers: [
      {
        id: 281,
        name: '富岡 洋',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://docs.google.com/presentation/d/1clRSwCMCxbraScwSXiFtiXZ0jLR4v5Og4J_LU0M3BVM/edit?usp=sharing',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'Pull Request の Review をするのに実際に触ってみたいことは多々あります。数多くの PaaS で変更の preview を簡単に見る URL を発行する機能がありますが、ユーザーには直接露出しないマイクロサービスにおいてこのアプローチを取る方法は自明ではありません。そこで Istio と Ambassador を使い、k8s クラスタを短時間コピーするという体験を実現することにより、どんな場所にある Microservice でも簡単に review できる仕組みを構築しました。',
    speakers: [
      {
        id: 321,
        name: '大坪新平',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/potsbo/copy-kubernetes-clusters-really-fast',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'ApigeeやAWSのAPI Gatewayのように、API schemaを用いてvalidation等を行なうゲートウェイサービスがにわかに盛り上がっている今日この頃。LINEのプライベートクラウドであるVerdaでも、API schemaをベースにしたAPI監視の仕組みやschemaを使ったエコシステムを導入し始めました。\r\nk8s nativeな設計、レガシーなAPIサービスへの対応、新しい監視の仕組みが役に立ったオペレーションなどの経験を元にした知見と、ユーザ体験を高めるための将来的な開発計画などについてお話しします。',
    speakers: [
      {
        id: 331,
        name: '萬治 渉',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/line_developers/api-monitoring-with-openapi-and-ecosystem-using-schema',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'Metal³はCNCFサンドボックスプロジェクトの一つであり、ベアメタルサーバとクラスタなどのオンプレ環境のインフラをアプリのように声明的に管理する機能を提供しています。このセッションではデモを通じてMetal³の基本を紹介します。また、富士通が今Metal³コミュニティで開発している機能も紹介します。',
    speakers: [
      {
        id: 361,
        name: '宋　書坤',
  ...
  },
  {
    ...
    abstract:
      'AKSとistio, flaggerなどを用いてサービスを運用していますが、それぞれをupgradeしていく中で直面した問題、解決したことなどを具体的な事象交えて紹介します。',
    speakers: [
      {
        id: 381,
        name: '柳本　浩一',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/kyanagimoto/cloudnative-days-tokyo-online-2021-311',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'クラウドネイティブ技術とは、スケーラブルなアプリケーションの実行能力を組織にもたらすことを目的にしています。しかしクラウドネイティブの定義にある「システムに回復力があり、管理しやすい疎結合なシステムが組織にスケール能力を与えている」ということを、システムの開発に関わるエンジニアはどのように “学習” していけば良いでしょうか？それも最小限の労力で。\r\n本セッションでは、エンジニアがクラウドネイティブを理解する１つの学び方として、「回復力」「管理のしやすさ」「疎結合なシステム」をオブザーバビリティ (可観測性)から得られるデータで学習していく方法を共有します。',
    speakers: [
      {
        id: 391,
        name: '東　卓弥',
  ...
  },
  {
    ...
    abstract:
      'Kubernetes(K8s)はコンテナオーケストレーションツールとして、様々なシステムのインフラ構築に利用され始めています。しかし、システムでコンテナを利用する機会がなく、K8sについて触れたことがない、よく分からないという人も多いのではないでしょうか。\r\n本セッションでは、K8sの基本的な仕組みについてMinikubeを使って解説します。',
    speakers: [
      {
        id: 421,
        name: '宮原 徹',
  ...
  },
  {
    ...
    abstract:
      'calico をアプデするつもりが、マニフェストを間違えていたせいで特定のリソースがGCされず\r\netcdのデータが肥大化していき、クラスタが操作不能になりそうになった話をします',
    speakers: [
      {
        id: 431,
        name: '川部 勝也',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/cwozaki/helm-chartrihositoriwo2nian-ban-yun-yong-sitewakatutairoironahua-cloudnative-days-spring-2021-online-number-cndo2021',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'Vaultとは、HashiCorp社が開発した秘匿情報を管理、保護するためのソフトウェアです。このセッションでは、実際にkubernetesのsecretをVaultで管理した事例を元に、Vaultについて紹介します。',
    speakers: [
      {
        id: 451,
        name: '佐藤 匠',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/takumisato0613/vault-on-kubernetes-at-cloudnative-days',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/tadashi777/clusterapi-woshi-tutekubernetes-falseraihu-saikuruwoguan-li-siyou',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/hirokimatsumoto/decide-the-way-of-deployment',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'マイクロサービスにおいて、データベースを用いてデータを管理するとき、いかにして分散したデータを整合させるか、課題になることがあります。そこで、本セッションでは、分散したデータの整合性を担保する、分散トランザクションの原則を示し、マイクロサービスに応用するための考え方を説明します。',
    speakers: [
      {
        id: 491,
        name: '西谷 淳平',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/MakihikoYamazaki/cloudnativedays2021-security-points-when-releasing-a-service-in-a-container-for-the-first-time-from-an-infrastructure-perspective',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/saramune/unun-sore-ec2-plus-asg-momatacloudnativedane-d6f1bab5-d162-4df5-9d0a-9a85c1334fae?slide=34',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'Docker やKubernetesには、様々な方法でテストを行い最小のコストで各種設定や開発者が行う設定を抑える仕組みがいくつも存在しています。しかしながらこれらの仕組みを最大限活用するには知識が必要です。本セッションではDocker/Kubernetes の中でもプロダクトや個人で利用しているツールやその周辺知識について説明できればと思います。',
    speakers: [
      {
        id: 561,
        name: 'Shuya Motouchi',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/yuichi110/tuo-dockerfile-cloud-native-buildpackstokpackwo-shi-tutajian-dan-dean-quan-naimezibirudo',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/mkohno/network-as-a-service-data-plane-evolution-and-abstraction-by-nsm',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'マルチテナントEKSクラスタ上に構築された各種サービスの構築・運用を開発者に委譲している話',
    speakers: [
      {
        id: 611,
        name: 'Goto Kenta',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/dongkayakuda/ec2apachephpecsfargate',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'NetworkPolicy、Calico NetworkPolicyで行うことの出来るPod間通信制御の概要と、ケース別に見た時の各リソースでの設定方法および、構築・運用時に注意した点等を話したいと思います。(初心者、中級者向け)',
    speakers: [
      {
        id: 641,
        name: '谷口純一',
  ...
  },
  {
    ...
    abstract:
      'SUSEがRancherを買収し、1月より本格的にSUSE Rancherとして提供を開始しておりますが、コンテナがいよいよ本格化するにあたりRancherってどうなのか？SUSE OpenStackからSUSE Rancherへとどう変わっていくのか？あの話題のストレージ『Longhorn』も含め、今一度クラウドネイティブ本格化時代にあたりおさらいを皆さんとできればと思っております。',
    speakers: [
      {
        id: 661,
        name: '太田　昌文',
  ...
  },
  {
    ...
    abstract:
      'Kubernetes をはじめ、さまざまなシステムから使える汎用的ポリシーエンジンである Open Policy Agent (OPA) の利用例が増えてきています。本セッションでは OPA の概要とアーキテクチャ、および、OPA で使われるポリシー記述言語である Rego について解説をし、Kubernetes の Policy エンジンとして使う場合の利用例についてデモを交えながら解説を行います。',
    speakers: [
      {
        id: 671,
        name: '進藤 資訓',
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/motonorishindo/open-policy-agent-opa-kubernetes-policy',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      '当社では、24/365・高トラフィック・高セキュリティ・低レイテンシーが求められる決済システムにおいて、ここ数年でクラウドネイティブへ挑戦してきた。何を目指し、どんなことに気をかけて、何がキモであったのか。そのアプローチ過程から得た教訓を紹介する。',
    speakers: [
      {
        id: 681,
        name: '三谷 隆',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/athagi/kubernetes-ganaishi-jie-false-cloudnative-ziyani',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'Dashboard as CodeとはDashboard管理にソフトウェア開発の原則を当てはめるプラクティスです。grafana, jsonnetでダッシュボード管理を改善できるか、どんな課題が出てくるかを紹介します。',
    speakers: [
      {
        id: 721,
        name: '瀨戸 啓一朗',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/keiichiro666/cndo2021-dashboard-as-codededatusiyubodoguan-li-hagai-shan-suruka',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      '去年 11月から Docker Hub の pull リクエスト制限が開始され、おそらく多くのプロジェクトが別のレジストリを探したり移行したりしていると思われます。様々な選択肢があると思いますが、その中では Harbor っていう CNCF プロジェクトがあります。本セッションでは、Harbor の概要とアーキテクチャを確認しながら、Harbor のメリットや最新のアップデート、セットアップのやり方を共有します。',
    speakers: [
      {
        id: 731,
        name: 'キム インソ',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/sano307/harbor-dezi-fen-tatifalsekontenarezisutoriwogou-zhu',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://drive.google.com/file/d/1bhpzowg6X_oVyR73TXyhTQnxV0yvrbpD/view?usp=sharing',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/ido_kara_deru/constructing-and-operating-the-observability-platform-using-istio',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      '「クラウドネイティブ技術をどうやって学んで、どうやって教える？」のポイントを整理して、「何から始めてよいのか分からない」からの1歩を"ともに踏み出す"にフォーカスします。',
    speakers: [
      {
        id: 771,
        name: '市川豊',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/cyberblack28/korekarashi-meruren-falsetamefalsekubernetes-and-cloud-native-2021',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/chaspy/metric-driven-decision-making-with-custom-prometheus-exporter',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: true,
    documentUrl:
      'https://speakerdeck.com/otty246/deployment-and-rollback-in-amazon-ecs',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'Amazon EKSでKubernetesの運用していく際、セキュリティについてどのように考えればいいのか、悩まれていませんか？\r\nこのセッションではAmazon EKSでセキュリティを確保するための考慮事項を整理してお伝えします。',
    speakers: [
      {
        id: 351,
        name: '林　政利',
  ...
  },
  {
    ...
    abstract:
      'Ubie は複数のプロダクトを国内外に展開しており、その内部には多数のサービスが関連しあっています。サービスの数とその複雑さの増加につれて Observability はますます重要になってきます。Ubie における適切な Observability の実現のためにどのようなツールを選び設計しているかをご紹介いたします。\r\n技術的にはPrometheusとCloud Monitoringの連携によるモニタリング環境の改善や、Istio/Zipkin/Cloud Trace連携について取り上げる予定です。',
    speakers: [
      {
        id: 821,
        name: 'Jun Sakata / Kaito Minatoya / Takuya Kosugiyama / Makoto Hasegawa / Takuma Nakagame',
  ...
  },
  {
    ...
    abstract:
      'Ubieでは、柔軟なロールアウト方法による安全なリリースと、リリースに関連したジョブの実行のためにArgoプロジェクトのソフトウェア(argo-rollouts/argo-events/argo-workflow)を利用しています。これらを導入した背景や、実現したい世界観を説明いたします。',
    speakers: [
      {
        id: 821,
        name: 'Jun Sakata / Kaito Minatoya / Takuya Kosugiyama / Makoto Hasegawa / Takuma Nakagame',
  ...
  },
  {
    ...
    abstract:
      'コンテナは軽くて、すぐにスケールする。はずなのに、起動に時間がかかって待たされるなんて残念な経験はありませんか？Javaのコンテナを最適化して快適に実行する方法をご紹介します。',
    speakers: [
      {
        id: 831,
        name: '大溝　桂',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/mita/orchestration-with-crossplane-and-open-application-model',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'Open Policy AgentはOSSでPolicy as Codeを実現するツールです。社内ではインフラの構築にTerraformが採用され、浸透してきています。一方、書き方や流派については統一されておらず、将来的にエンジニアへの負荷も懸念されました。そこで本セッションではOPAを利用したTerraformのコードをどれだけ統一できるかに挑戦しました。',
    speakers: [
      {
        id: 851,
        name: '伊藤太斉',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/hatasaki/azure-falsemanezidonaopenshift-sabisu-aro-falseyun-yong-falsekotu',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      '移動体や固定通信を支えるネットワークシステムにおいても，NFV型の仮想化が進んでいるが，近年クラウドネイティブ技術が取り入れられつつある．移動体や固定通信を支えるネットワークシステムでは特殊なプロトコルや設備条件等様々な制約があるため，クラウドネイティブのアプローチをそのまま利用することができず，NFVでのベストプラクティスを見出していく必要がある．本セッションでは我々のプロジェクトでこれまでに取り組んできたアーキテクチャや構成技術について紹介し，現在の課題についてディスカッションしたい．',
    speakers: [
      {
        id: 871,
        name: '篠原健太',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://docs.google.com/presentation/d/1FYbzsli4x9YJvNefbKQ8-NR3VWyC5Ou8WhKF32Cy8b4/edit?usp=sharing',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'Kubernetes における Operator/Controller の役割は，K8sを上手に活用したいシーンにおいて非常に重要です。しかしながら，それらを全く意識しないままに K8s にトライしている方々を多く見かけます。知ってて損は無い Operator/Controller について，初心者の方向けに5分で解説します。',
    speakers: [
      {
        id: 911,
        name: '斎藤 和史',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://drive.google.com/file/d/1MglnkQiCyxWC9oi62DuHxK1a6LDLherm/view?usp=sharing',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/shosuz/elastic-observabilitycansmartlymanagetheappsonkubernetes',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      '現場において負荷試験を実施する際に試行錯誤の上、コンテナのメトリクスを調査した内容を共有します！共感いただける方がいらっしゃると嬉しいです。',
    speakers: [
      {
        id: 951,
        name: '島田雄太',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/yoshiki0705/cloudnative-days-spring-2021-online',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/hassaku63/serverless-development-practices-the-next-step-of-hello-world',
    conferenceDayId: 7,
    conferenceDayDate: '2021-03-12',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'Certified Kubernetes Administrator (CKA) 試験とCertified Kubernetes Application Developer（CKAD）試験は、Kubernetesに関するスキルを証明するための、コマンドラインを使ったハンズオン形式の資格試験です。\r\n\r\nこのセッションでは、Kubernetesアプリケーションの開発者に必要なスキルや知識の証明として取得してみよう！ということで、これからKubernetesの勉強を始める方に向けてCKA/CKADの出題範囲に沿っていくつかの問題を解いていきます。',
    speakers: [
      {
        id: 991,
        name: 'Shiho ASA',
  ...
  },
  {
    ...
    abstract:
      'CircleCIでは継ぎ足しで自前運用してきたK8SクラスターをEKSへ移行しました。その時に用いたパターンや学びを共有したいと思います。',
    speakers: [
      {
        id: 1001,
        name: '金 洋国',
  ...
  },
  {
    ...
    abstract:
      'Cloud Native というとサーバーやコンテナ技術 (とその利用方法) に目が向きがちですが、今や ML | AI モデルの構築やそれを使ったサービス構築もクラウドの恩恵を十二分に受けています。また、AI というと何から始めたら良いのか、ハードルが高いと思う方が多いのも事実。\r\nこのセッションでは、サーバーレス & ローコードで(＝そんなに開発スキルが高くなくても大丈夫！) AI | Cognitive 技術、サービスを利用する、AI への第一歩を踏み出す方法をお話しします。',
    speakers: [
      {
        id: 1021,
        name: '大森 彩子',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/acquiajp1/cloud-native-cms-development-with-acquia-cloud-platform',
    conferenceDayId: 6,
    conferenceDayDate: '2021-03-11',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    videoId: '521006177',
    title:
      'NGINX Ingress Operator・OpenShift環境でNGINXを活用 / OperatorでKubernetesを気軽に拡張する',
    abstract:
