...
export const CNDF2023Talks: Talk[] = [
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1840/68/playlist.m3u8',
    title: '継続的プロファイルによる大規模アプリケーションの性能改善',
    abstract:
      'オブザーバビリティの普及が進む中、近年継続的プロファイルが注目を集めてきています。本セッションでは、オブザーバビリティシグナルとして、なぜプロファイルが注目されるようになったのか、そして継続的プロファイルの概念を紹介します。それらを踏まえて、実際に現時点で利用できる継続的プロファイルツールの概要と、実際にそれらを活用することでどのような問題が解決できるのかを、具体例を交えて解説します。',
    speakers: [
      {
        id: 1476,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1842/69/playlist.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1846/1846.m3u8',
    title:
      'メルカリにおけるプラットフォーム主導のKubernetesリソース最適化とそこに生まれた🐢の可能性',
    abstract:
      'PlatformチームではKubernetesのリソースの最適化を行っています。殆どのサービスが同一のクラスターに乗っていることから、Platformとして行う最適化の効果は大きい反面、莫大な量のサービスの詳細を把握し切ることはできない中、それらを壊さない安全なリソースの最適化が求められます。このセッションでは、Platformとして行われてきた全体一貫の最適化の試み/検証と、そこに産まれたツールTortoiseに関する紹介を行います。',
    speakers: [
      {
        id: 1477,
        name: 'Kensei Nakada',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1848/78/playlist.m3u8',
    ...
    onAir: true,
    documentUrl:
      'https://speakerdeck.com/196ikuchil/chu-xin-zhe-demowakarukubernetes-schedulerkuo-zhang-noquan-tetosonozui-qian-xian',
    conferenceDayId: 25,
    conferenceDayDate: '2023-08-03',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1866/76/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1882/65/playlist.m3u8',
    title: 'Gateway API と eBPF で進化する GKE Networking',
    abstract:
      'Kubernetes Networking 界隈で今ホットな Gateway API や eBPF といったテクノロジーが Google Kubernetes Engine (GKE) でどのように取り込まれて活用されているのかについてご紹介します。',
    speakers: [
      {
        id: 1522,
        name: 'Kazuki Uchima',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1885/66/playlist.m3u8',
    title: 'k8sgpt Deep Dive: KubernetesクラスタのAI駆動型分析について',
    abstract:
      'この講演では、AI駆動型ツールk8sgptの仕組み、機能、制限を掘り下げます。k8sgptはKubernetesクラスタをスキャンし、診断し、トリアージすることができますが、それはカスタマイズ可能なアナライザーと連携するAIプロバイダーを介して行います。しかし、AIの結果は必ずしも完全ではなく、経験と人間の判断がまだまだ重要です。SRE、DevOps、インフラエンジニアにとって、k8sgptの深い理解はKubernetes管理の新たな可能性を開くでしょう。',
    speakers: [
      {
        id: 1525,
        name: 'nwiizo',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1890/74/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1907/61/playlist.m3u8',
    title: '現場の課題に向き合うために大事にしていること',
    abstract:
      '私はクアンドにて、自社プロダクトの構想から開発・運用・改善の一連の流れを経験しました。\r\nその中で、エンジニア組織としてビジネスインパクトを最大限に創出するために、何をなぜ大切にしているかを、実例も踏まえつつお話しできればと思います。',
    speakers: [
      {
        id: 1548,
        name: 'Arashi Takano',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1908/72/playlist.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/acquiajp1/kontentushe-ji-shou-fa-debian-geng-niqiang-iapurikesiyonwoshi-xian-suru-rokodoniyoruwebapurinobatukuendoshi-zhuang-number-cndf2023',
    conferenceDayId: 25,
    conferenceDayDate: '2023-08-03',
    presentationMethod: '現地登壇',
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/utam0k/kuraudoneiteibunoji-pan-yao-su-kontenanojin-towei-lai',
    conferenceDayId: 25,
    conferenceDayDate: '2023-08-03',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1911/64/playlist.m3u8',
    title: '人工衛星運用システムにおけるクラウドアーキテクチャ設計',
    abstract:
      'QPS研究所では、人工衛星の運用を行う全てのシステムをフルクラウドで構築しています。\r\n多数の人工衛星を効率よく運用していくためのシステムアーキテクチャ、\r\nおよび人工衛星ならではの課題やそれに向けたクラウド技術を活用した対策についてもご紹介します。',
    speakers: [
      {
        id: 1552,
        name: 'Shuichi Tanaka',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://sysdig.jp/wp-content/uploads/Sysdig_CNDF_2023-8-3_v2.pdf',
    conferenceDayId: 25,
    conferenceDayDate: '2023-08-03',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1913/1913.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/kametaro/enterprise-generative-ai-on-cloud-native',
    conferenceDayId: 25,
    conferenceDayDate: '2023-08-03',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1914/73/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndf2023/talks/1916/77/playlist.m3u8',
    title: 'ElasticsearchによるAIOps',
    abstract:
      'ChatGPTに代表される生成AIが世間を賑わせていますが、検索老舗のElasticsearchも当然この方面は取り組んでいます。\r\n機械学習を使ったAIOpsからOpen AIと連携させるSecurity Assistant機能など、多彩な機能と新しい使い方をご紹介いたします。',
    speakers: [
      {
        id: 1557,
        name: 'Takeo Furukubo',
