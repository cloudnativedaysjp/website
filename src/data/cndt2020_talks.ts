...
export const CNDT2020Talks: Talk[] = [
  ...
  },
  {
    ...
    abstract:
      'クラウドネイティブという言葉の定義には、管理性や可観測性が高く、自律制御したシステムなどの意味が含まれています。インフラの観点で言えば、自律制御の恩恵は非常に大きいですが、その一方でアプリケーションの正常性や健全性が保たれているか、継続的にサービスを提供できる品質になっているかなどの観点も含めて考慮する必要があります。\n本セッションでは、今までオンプレでインフラを守ってきたエンジニアが新しいプロジェクトに入り、開発の知見やアプリケーションの仕組みに正面からぶつかりながら「クラウドネイティブ」なインフラを作るために乗り越えながら開発者出身のエンジニアとともにオンボーディングを進めてきた事例についてお話します。',
    speakers: [
      {
        id: 2,
        name: '太田 航平',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/polar3130/portable-microservices-with-dapr-and-kubernetes',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/pfi/how-to-schedule-machine-learning-workloads-nicely-in-kubernetes-cndt2020-cloud-native-days-tokyo-2020 ',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'Kubernetesを代表とするシステムとアプリケーションの監視をする上で、Observabilityは欠かせない要素になっています。しかし、それを実現するためには何から手を付けたら良いのか、よく分からないという方は多いのではないでしょうか。\n本セッションでは、Observabilityを実現するための全体像と、Metrics/Logs/Tracesぞれぞれの視点でのファーストステップをご紹介します。',
    speakers: [
      {
        id: 13,
        name: '仲亀 拓馬',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/ysakashita/persistentvolumefalse-bu-jin-ndashi-ifang',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'Wantedly は約 100 のマイクロサービスを組み合わせて、Wantedly Visit や Wantedly People というサービスを開発しています。これまではマイクロサービス間通信の中心技術として HTTP/1.1 を採用してきましたが、昨年から gRPC の導入を開始し、今では traffic の多い主要な通信部分は gRPC へ移行して averatge latency の 50% 改善、90%tile latency の 85% 改善を達成できました。\nこのトークでは、gRPC という通信技術についての詳細な説明から、gPRC を利用することによるメリット、gRPC を利用することで実際に得られたパフォーマンス改善、gRPC への移行を行うための実践的な TIps についてお話しします。移行の際にはツールやライブラリの開発や開発フローの整備など技術的、組織的な挑戦を行なっており、その詳細についてもお話しいたします。',
    speakers: [
      {
        id: 15,
        name: '南 直',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/south37/real-world-migration-from-http-to-grpc-number-cndt2020',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/toversus/reliable-and-performant-dns-resolution-with-high-available-nodelocal-dnscache',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/kameikki/authentication-service-replacement-and-security-efforts-of-zozotown-cndt2020 ',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/koba1t/kasutamukontororahamo-neng-nafalsedeapurikesiyonwozuo-rutamenimoshi-eru',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      '　Kubernetes運用の自律化として、本番環境でも活用され始めているOperator。しかし、Operatorもアプリケーションのため、それ自体を管理しなければいけません。これを解決するのが、オープンソースのOperator Frameworkの一つであるOperator Lifecycle Management(OLM)。\n　Operatorのアップグレードや依存関係を解決するOLMの全容を紹介しますっ。',
    speakers: [
      {
        id: 27,
        name: '北山 晋吾',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/shkitayama/operatorlifecyclemanager-101',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/ryysud/comparison-of-identity-management-and-access-control-features-of-major-service-mesh-products ',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/kobarasukimaro/ai-fan-yi-sabisuwo-faas-kontenahua-site-ux-tokosutowogai-shan-sitahua',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/kentatada/embedded-container-runtime-using-linux-capabilities-seccomp-cgroups',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/morimoto/kubernetesdecephkurasutayong-falsesutoreziwodouguan-li-suruka-fen-ge-topei-zhi-falsezui-shi-hua-hefalsequ-rizu-mi ',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      '2020年4月にリリースされたクラウドゲーミングプラットフォーム「OOParts」。往年の名作ゲームを、モダンなアーキテクチャであらゆるデバイスでプレイできるようにしました。この発表では、「OOParts」がどのようなアーキテクチャで動作しているのか、どのようなコンポーネントが使用されているのかを皆様にご紹介します。',
    speakers: [
      {
        id: 41,
        name: '中村 勇介',
  ...
  },
  {
    ...
    abstract:
      'メルペイのサービスはGCP上で稼働しマイクロサービスを構成しています。各マイクロサービスではアプリケーションはコンテナ化されGKE上で動き、DatabaseやPub/SubといったGCPのクラウドリソースもマイクロサービス毎に独立し各チームで管理しています。\nメルペイではOpen Policy AgentのRegoによるポリシーを作成し、Conftestを用いて各リソースに対してのテストを行うことで、サービスの信頼を維持する取り組みを行っています。このセッションではこれらのツールや活用方法について紹介します。',
    speakers: [
      {
        id: 42,
        name: '湯原 孝明',
  ...
  },
  {
    ...
    abstract:
      'この数年Serverlessが注目され、関連する技術や取り巻く環境も変化してきました。本セッションでは、メルカリにおける勤怠打刻システムをServerlessで構築し1年間運用してきた経験をもとに、Serverlessでのシステム設計や開発・運用の事例と、Serverlessの動向を紹介します。Serverlessでプロダクトづくりを検討している方や、既に利用している方に、試行錯誤の経験を共有したいと思います。',
    speakers: [
      {
        id: 43,
        name: '山下 慶将',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/keisukeyamashita/serverlesswoqu-rijuan-kuxian-zhuang-toall-serverlessdepurodakutowogou-zhu-suruku-lao',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/kennygt51/vault-plus-eks-plus-aws-ssoteshi-xian-surumi-mi-qing-bao-guan-li',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/hamadakoji/kuraudoneiteibushi-dai-nizui-shi-hua-saretaenziniaringuzu-zhi-falsezhui-qiu ',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/ymmt2005/monolith-to-cloudnative-cndt2020 ',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      '講演者は学生来プラットフォームの開発者側に立ち、2年前まではCNCFのボードメンバもしくは社内のプラットフォームOSS開発に従事してきた。2018年12月から新たなSaaS、Tunaclo API Connectの開発において少人数チームの責任者となりプラットフォームを提供する側から使う側の立場に初めて立つことになった。\n社内公募からクラウドネイティブ技術に始めて触れるエンジニアを集めてチームを結成してからこれまでの中で、うまくいっていること、いかないこと、必要なスキルセット、理想と妥協、最初に考えておくべきだったこと、必要なフォロー、今後試したいことなど色々と反省しつつ明るく振り返ります。',
    speakers: [
      {
        id: 48,
        name: '亀澤 寛之',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/hiro_kamezawa/toarushao-ren-shu-timufalsecloudnativehefalsechuan-chu-falsehua',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  {
    ...
    abstract:
      'GKE / Spanner / 常に最新を掲げて新しいテクノロジーを導入していく組織の立ち上げから新規サービスへの導入まで',
    speakers: [
      {
        id: 49,
        name: '菅井 健太',
  ...
  },
  {
    ...
    videoId: '454783800',
    title:
      '急速な成長を加速させるアーキテクチャ〜オープンテクノロジー・マルチクラウドの活用〜',
    abstract:
  ...
  },
  {
    ...
    abstract:
      '昨今は、アプリケーション開発者の方もKubernetesに興味をお持ちの方が多いでしょう。しかし「インフラはあまり良くわからない」「機能が多くて何から勉強すればいいか分からない」という方も多いのではないでしょうか。このセッションでは、アプリケーション開発者が知っておくべきKubernetesの知識をコンパクトにお伝えします。今後のKubernetes学習のきっかけになれば幸いです。',
    speakers: [
      {
        id: 54,
        name: '多田 真敏',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/furusawakei/cndt2020tunaclo-api-connect',
    conferenceDayId: 2,
    conferenceDayDate: '2020-09-09',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      'OSSのAPIGatewayでおなじみのKongが開発する、サービスメッシュのKumaがCNCF Sandboxにエントリされました。今後一層の注目を集めるであろうと、当社で開発中のサービス(SIOS bilink)にKumaを使ってみたらどうなるか？試してみました！',
    speakers: [
      {
        id: 61,
        name: '槌野 雅敏',
  ...
  },
  {
    ...
    videoId: '454738221',
    title:
      'クラウドネイティブを実現するコンテナ・Kubernetesにセキュリティは足りてますか？WAF機能を備えた唯一のIngress Controller',
    abstract:
      'NGINX Ingress ControllerはKubernetes上で実行しているアプリケーションへ外部からのアクセスやエントリーポイントとして動作し、TCP/UDPとL7ロードバランシグや、F5/NGINXが取り組んでいるWAFサポートを提供しています。\r\n本講演ではNGINX Ingress Controllerのベストプラクティスやアプリケーションへの負荷分散や高度な制御、WAF連携についてご紹介します。',
    speakers: [
      {
        id: 62,
        name: '鈴木 孝彰',
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/Nginx/nginx-ingress-controller-with-waf-for-kubernetes',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  ...
  },
  {
    ...
    abstract:
      '昨今，Kubernetesクラスターを使いこなしている企業・ユーザーが目まぐるしい活躍をされています。一方でKubernetesの魅力に惹かれてチャレンジしているものの苦労を重ねているケースもよく目にします。例えば，クラスターのバージョンアップについて苦労する理由はどこにあるのでしょうか。どのように解決するのでしょうか。考え方はもちろんのこと，実パターンを挙げて解説します。',
    speakers: [
      {
        id: 64,
        name: '斎藤 和史',
  ...
  },
  {
    ...
    abstract:
      'Yahoo! JAPANが行ってきた、コンテナ化の推進におけるセキュリティの課題とは何か。その対処をどのように考え、実際にどのようにSysdig Secure DevOps Platformを活用し解決しようとしているのか実践的なお話を想定しています。',
    speakers: [
      {
        id: 65,
        name: '佐野 雄一郎',
  ...
  },
  {
    ...
    abstract:
      '皆さん GKE 使ってますか？ 2015 年に登場して以来、多くの機能追加があり成熟度が増す GKE ですが、設定オプションが多くて何をどう設定すればよいか分からないってことはないでしょうか？本セッションでは最新情報を交えながら GKE を本番環境で利用する上で重要となるクラスタ設計 / 運用のベストプラクティスを解説します。',
    speakers: [
      {
        id: 66,
        name: '篠原 一徳',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/youta1119/cndt2020-amebaahuirieitoji-pan-false-gkeakitekutiyato-maikurosahisu ',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  {
    ...
    videoId: '454785553',
    title:
      '継続的なソフトウェアアップデートのためのDevOpsベストプラクティス・アンチパターン',
    abstract:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/ihcomega56/devops-patterns-and-antipatterns-for-continuous-software-updates',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
  {
    ...
    videoId: '454763847',
    title:
      'Cloud Native Projects: Powering your life everyday featuring Pinterest & Zalando',
    abstract:
      'CNCF is an open source software foundation dedicated to making cloud native computing universal and sustainable. We are a community of open source projects, including Kubernetes, Prometheus, Envoy, and others. Cloud native technologies empower organizations to build & run scalable applications in modern, dynamic environments such as public, private, & hybrid clouds.',
    speakers: [
      {
        id: 72,
  ...
  },
  {
    ...
    abstract:
      '日本におけるKubernetesの採用は、昨年に比べ確実に増えています。一方、エンタープライズにおいてKubernetesを使いこなすにはいまだ多くのチャレンジがあると考えます。さらには、アプリケーションデベロッパーにとって使いやすいプラットフォームである必要があります。\r\nこのセッションでは、VMwareがPivotalおよびHeptio社の買収を通じてKubernetesをエンタープライズで使いやすくするためにどのような取り組みを行なっているのかをご紹介します。',
    speakers: [
      {
        id: 74,
        name: '星野 真知',
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/xibuka/k3swohuo-yong-sita-cloud-nativeshi-dai-falseiotapuri ',
    conferenceDayId: 1,
    conferenceDayDate: '2020-09-08',
    presentationMethod: null,
  },
