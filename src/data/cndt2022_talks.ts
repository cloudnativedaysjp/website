...
export const CNDT2022Talks: Talk[] = [
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1509/1509.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/sshota0809/tuo-yan-zi-ke-sasutenahurunakubernetesekosisutemunoguan-li-wositeikutameni',
    conferenceDayId: 18,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1511/37/playlist.m3u8',
    title: 'DMMプラットフォームを支える負荷試験基盤',
    abstract:
      'DMMプラットフォームで共通利用できる負荷試験基盤をk8sに構築しました。本セッションでは、負荷試験基盤を開発した背景、MVPの設計方針、開発する上で困難だったことを紹介します。負荷試験基盤のMVPの設計をする前に、想定ユーザーからとったアンケート結果も公開します。これから負荷試験を効率良く行うための仕組みをつくる人にとって参考になる情報を提供できると思います。',
    speakers: [
      {
        id: 1328,
        name: 'yuyu_hf',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/yuyu_hf/cndt-2022-dmm-load-testing-platform-for-dmm-platform',
    conferenceDayId: 19,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1512/1512.m3u8',
    title: '目で見て体験！ Kubernetesのしくみ',
    abstract:
      'Kubernetesは、その動作が直接は目に見えないため、特に初心者にとってはとっつきにくい面があります。特にマルチ・ノードでの動作を確認しようと思うと複数のサーバをセットアップしなければならず、その点でも敷居が高いと言えるでしょう。本講演ではRespberry Pi上にKubernetes環境を構築し、その上で「目に見えるWebサーバ(アクセスがあるとLEDが点灯する)」を実行することでKubernetesの動作を確認していきます。こちらの書籍からの内容の抜粋となります。 https://www.amazon.co.jp/dp/4297123193',
    speakers: [
      {
        id: 1330,
        name: 'Shisei Hanai',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1513/43/playlist.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://docs.google.com/presentation/d/1AIGNk1FLS9dsAzKbSoj80BuW7-CaMFkaT5qZwvQVpdE',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1516/1516.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1519/1519.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1521/22/playlist.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1522/1522.m3u8',
    title:
      'モヤモヤをスッキリ、理解の点と点を繋げて、コンテナセキュリティを得意分野に！',
    abstract:
      '広がるクラウドネイティブ、技術者や管理者の方々の学習範囲も多岐に渡っています。\r\nその中で、コンテナセキュリティを得意分野にできたら強いと思いませんか？\r\n皆さんの『苦手』⇒『面白い≒得意』となるキッカケになれたら幸いです。',
    speakers: [
      {
        id: 1342,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1523/1523.m3u8',
    title: 'AWS、GCP、Azureのサーバレスの利用実態とAWSサーバレスのモニタリング',
    abstract:
      'DatadogはAWS、GCP、Azureで多く使われているクラウドモニタリングのSaaSです。Datadogが2022年にかけて行った調査から、AWS、GCP、Azureの利用実態のそれぞれの特色を紹介し、特にAWSのサーバレス環境でのモニタリングの手法をご紹介します。',
    speakers: [
      {
        id: 1343,
        name: 'Taiji Hagino ',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1526/38/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1527/40/playlist.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://www.slideshare.net/YutaShimada/cndt2022sier-254380026',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
    presentationMethod: '現地登壇',
  },
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1530/1530.m3u8',
    title: 'PostgreSQLとApache Kafkaのマルチクラウド環境をワンクリックで構築',
    abstract:
      'DevOpsや開発者が、オープンソースデータベースをパブリッククラウド上に構築した際、運用やセキュリティなど多くの課題に直面します。マネージドオープンソースデータテクノロジーを提供するAivenは、圧倒的に学習コストが低く、高い可用性、マルチクラウド/リージョンへの対応などをパブリッククラウド上で実現します。今回は、Aivenのサービスの中から、PostgreSQL及びApache Kafka に焦点を当て、デモを交えてご説明します。',
    speakers: [
      {
        id: 1351,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1531/36/playlist.m3u8',
    title: 'AWS Outpostsで始めるエッジコンピューティング',
    abstract:
      '通信遅延やセキュリティ保護要件上の課題を解決するために、端末の近距離にサーバを設置するエッジコンピューティングが提唱されています。しかし、オンプレミス環境にセキュアかつ適切にスケールするコンピュート・ストレージ環境の構築・運用を行うのは困難が伴います。この課題を、オンプレミスでAWSサービスを実行可能な「AWS Outposts」によって解決し、エッジコンピューティングを実現する様々なユースケースについて発表します。',
    speakers: [
      {
        id: 1354,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1532/23/playlist.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1533/20/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1534/39/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1536/1536.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1537/34/playlist.m3u8',
    title: 'SLO策定までの道とChaosEngineeringを使った最適解の見つけ方',
    abstract:
      'みなさんはSLOのターゲットをどのように決めていますか？Chatworkでは今回SLI/SLOの見直しを行いました。これまでは、現状の値をもとになんとなくターゲットを設定していましたが、今回は、ChaosEngineeringを用いてサービスレベルを実際に確認し、SLOのターゲットを模索してみました。その過程と方法をお話します。',
    speakers: [
      {
        id: 1360,
        name: 'Shinya Sasaki',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1539/1539.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1541/1541.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1542/1542.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1544/1544.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1546/1546.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://docs.google.com/presentation/d/12p3kY-CCJl1yvokAvnaMQsqkH0S7xndudd72oq651tI/edit?usp=sharing',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
    presentationMethod: '事前収録',
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://drive.google.com/file/d/1MRw__oRdH-LkGj57BRdBAYTRGObhrQG8/view?usp=sharing',
    conferenceDayId: 18,
    conferenceDayDate: '2022-11-21',
    presentationMethod: '事前収録',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1548/44/playlist.m3u8',
    title: 'KeycloakでFAPIに対応した高セキュリティなAPIを公開する',
    abstract:
      '昨今、自社のサービス提供などを目的としたAPIが増えたことにより、それらAPIに対する攻撃の脅威が日に日に増しており、関連する事件や事故を耳にすることも多くなってきました。そんな中でOpenID Foundationが昨年3月に、OAuthやOpenID Connect (OIDC)よりも高いレベルのセキュリティを必要とするあらゆる市場領域のAPIに適用できる、Financial-grade API (FAPI) 1.0の最終版を公開しました。IAMのOSSであるKeycloakは同年6月にいち早くFAPI 1.0をサポートしました。\r\n本セッションでは、FAPIが提供する高いレベルのセキュリティやKeycloakを使ってFAPIを実現する方法について説明します。',
    speakers: [
      {
        id: 1369,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1550/1550.m3u8',
    title: 'ScalarDB: Cloud-native Transaction Manager',
    abstract:
      'クラウドネイティブなトランザクションマネージャであるScalarDBでは、マイクロサービスにおいてトランザクションを実現する機構や、マイクロサービスごとのトランザクションの状態(Read Set, Write Set等)をスケーラブルに管理する機構等を提供している。本セッションでは、それらの機構を概観しながら、マイクロサービスでのトランザクションにおける課題や勘所を説明する。',
    speakers: [
      {
        id: 1371,
    ...
    onAir: false,
    documentUrl:
      'https://scalar-labs.app.box.com/v/CloudNativeDaysTokyo2022/file/1077630754603',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
    presentationMethod: '事前収録',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1551/1551.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1553/1553.m3u8',
    title:
      'Self-Hosted Runners & Actions Runner Controller (ARC)を運用すること',
    abstract:
      'GitHub Actionsの実行環境の一つであるSelf-Hosted Runnersを1年以上運用してたまった知見とOSSとして公開されているActions Runner Controllerのアーキテクチャや導入方法について話します。Github actionsやCircleCIの利用者がSelf-Hosted Runnersを検討するための講演です。',
    speakers: [
      {
        id: 1374,
        name: 'Akito Fujihara',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1555/1555.m3u8',
    title: '旅するCSO 鈴木いっぺいの「KubeCon現地リキャップ」',
    abstract:
      'アメリカ、ミシガンで2022/10/24-28に行われるTHE KUBECON + CLOUDNATIVECON の現地レポートを踏まえ、要点をまとめてお届けいたします。',
    speakers: [
      {
        id: 1352,
        name: 'Ippei Suzuki',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1556/1556.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1557/1557.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/takutakahashi/shi-li-karaxue-bu-kubernetes-custom-controller-nozhuang-tai-guan-li',
    conferenceDayId: 18,
    conferenceDayDate: '2022-11-21',
    presentationMethod: '事前収録',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1558/1558.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/takutakahashi/prometheus-anomaly-detection',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
    presentationMethod: '事前収録',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1559/49/playlist.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/pospome/maikurosabisutok8sniokeruze-ren-jing-jie-she-ji-torisosuguan-li',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1560/1560.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1561/21/playlist.m3u8',
    title:
      '金融システムにおけるクラウドネイティブなアーキテクチャ設計とその構築',
    abstract:
      '高換金性情報を取り扱う金融システムでは高度なセキュリティが求められており、クラウド上にシステムを構築することが非常にシビアになっています。そのような開発現場においてどのような観点でアーキテクチャ設計し構築しているかを、下記の項目をメインに取り扱いながらご紹介させていただきます。\r\n\r\n・全体のアーキテクチャ設計について\r\n・クラウドベンダの選定理由\r\n・ハイブリッドクラウドの構成',
    speakers: [
      {
        id: 1379,
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/tetsun/jin-rong-sisutemuniokerukuraudoneiteibunaakitekutiyashe-ji-tosonogou-zhu',
    conferenceDayId: 18,
    conferenceDayDate: '2022-11-21',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1563/25/playlist.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1566/32/playlist.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/hashitokyo/cloud-native-kafka-d5d814ab-c5b0-4d89-b215-93410e17650a',
    conferenceDayId: 18,
    conferenceDayDate: '2022-11-21',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1567/1567.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1569/48/playlist.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/yaegashi/bandainamukosutazioniokerukuraudoneiteibunagemukai-fa-sutazionotiao-zhan',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
    presentationMethod: 'オンライン登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1570/1570.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://docs.google.com/presentation/d/1kJuWXRbn1GZmZGSd-jqX0p4KQ7HypAvi2RUKKUOry7c/edit?usp=sharing',
    conferenceDayId: 18,
    conferenceDayDate: '2022-11-21',
    presentationMethod: '事前収録',
  },
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1573/29/playlist.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1575/27/playlist.m3u8',
    title:
      'たまにはオンプレもいいぞ？ GKE と Armadillo IoT で実現するハイブリッドクラウド',
    abstract:
      'Google Kubernetes Engineを中核にArmadillo IoT GWというIoT製品と様々なネットワーク技術を組み合わせた上でのハイブリッドクラウドの実例をご紹介します。弊社ビットキーにおける大規模ビル制御プロダクトにおけるリアーキテクチャに際し、完全なオンプレシステムからハイブリッドクラウドへの移行を行っています。設計の勘所、機能面のメリデメ、運用コストの削減など全体的にお話します。',
    speakers: [
      {
        id: 1391,
        name: 'Ryo Sasaki',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1576/1576.m3u8',
    title:
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/minorun365/inisienoenpuraqing-sisuganei-zhi-hua-dehanakuakitekutono-shou-nonei-hua-wotui-jin-sitahua',
    conferenceDayId: 18,
    conferenceDayDate: '2022-11-21',
    presentationMethod: '事前収録',
  },
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1580/30/playlist.m3u8',
    title: 'SLO策定のIaC化によるSREの加速',
    abstract:
      'クラウドネイティブなシステムとSREによる運用は相性が高く、その中でも特に重要なのがSLOの決定とその反映です。本セッションではOpenSLOやSLO GeneratorといったSLOのIaC化を支援するツールについてその必要性の背景からご紹介し、日々の運用に活用する方法を具体例を交えながらご紹介します。本セッションによって、SLOの定義からアラートへの反映まで一貫した管理の手法について深い理解が得られるでしょう。',
    speakers: [
      {
        id: 1396,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1582/33/playlist.m3u8',
    title: '同志諸君よ、ゼロトラストを撃て',
    abstract:
      'O’Reilly　Japanから翻訳されたゼロトラスト・ネットワークが発刊され３年が経過しました。当初は、まさしく本カンファレンスのHPが言及するように、「物理的・時間的な距離を超えた」環境を想定したセキュリティ上の考え方でした。しかし、皆様も３年間のインシデントなどからお気づきの通り、ゼロトラストの適用は従来のセキュリティ・レベルを単純に強化するものではありません。昨今の事例を振り返りつつ、充足させていかねばならないポイントを技術事例も含めお話いたします',
    speakers: [
      {
        id: 1398,
        name: 'Kengo Suzuki',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1589/42/playlist.m3u8',
    title:
  ...
  },
  {
    ...
    onAir: false,
    documentUrl:
      'https://speakerdeck.com/onsd/kubefork-development-experience-like-owning-your-own-cluster',
    conferenceDayId: 18,
    conferenceDayDate: '2022-11-21',
    presentationMethod: '現地登壇',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1591/47/playlist.m3u8',
    title: '謎は全て解けた！ 安楽椅子探偵に捧げる AWS ネットワーク分析入門',
    abstract:
      'その不可解な事件はクラウドのネットワーク上で発生した…。疎通できるはずの通信が何故か繋がらなかったり、逆にセキュリティ的に危険な通信がうっかり繋がってしまったり。複雑なネットワーク設定に立ち向かう上で、「実際に ping を打つ」以上に網羅的で体系的な分析は可能でしょうか？ 本講演では、SMT ソルバを用いて、実際の通信を行うことなしにネットワーク上の問題を「推理」させる手法について解説します。',
    speakers: [
      {
        id: 1406,
        name: 'Cheshire Cat',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1594/1594.m3u8',
    title: '100%クラウドベースのデジタル体験基盤(DXP)開発フロー',
    abstract:
      '開発者がより良いデジタル体験を構築するには、アプリケーションを継続的に改善するための土壌が必要不可欠です。アクイアではクラウドネイティブに設計されたスケーラブルなCMSホスティング環境に加え、昨今の開発スタイルに適した開発ツールを含めて提供することで、開発者がやるべきことに注力できる環境を提供しています。\r\n本セッションでは、デジタル体験プラットフォーム（DXP）の開発ワークフローを100％クラウドベースでシームレスに完結するソリューションをご紹介します。 ',
    speakers: [
      {
        id: 1409,
        name: 'Shumpei Kishi',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1596/1596.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1597/1597.m3u8',
    title:
      '【対談】HashiCorp×TED -インフラのクラウドシフトを促進する最新機能とクラウドネイティブなマルチベンダー連携事例-',
    abstract:
      'まだ日本では発表していない 最新 の””HashiCorp社の製品アップデート情報やHashiCorp社の複数の製品を使いマルチベンダーで構成されたクラウドネイティブ環境における自動化のユースケースをご紹介します。また、お客様のインフラのクラウドシフトやクラウドネイティブ化を支援してきた二社ならではの、実情からみえてくる今後の課題と対策について考察します。マルチクラウド・ハイブリッドクラウド環境の運用に従事する方々が抱える現実的な課題を解決するためのヒントがここにあるはずです。',
    speakers: [
      {
        id: 1412,
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1598/1598.m3u8',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1599/1599.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1600/1600.m3u8',
    ...
    onAir: false,
    documentUrl:
      'https://www.dropbox.com/s/4mjxklcmk4xilr7/Kubernetes%E3%82%AF%E3%83%A9%E3%82%B9%E3%82%BF%E7%AE%A1%E7%90%86%E3%81%8B%E3%82%89%E3%81%AE%E8%A7%A3%E6%94%BE.pdf?dl=0',
    conferenceDayId: 19,
    conferenceDayDate: '2022-11-22',
    presentationMethod: '事前収録',
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/mediapackage/cndt2022/talks/1601/18/playlist.m3u8',
    title:
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1602/1602.m3u8',
    title: 'フロントエンド開発に集中するためのクラウドネイティブ環境を使おう',
    abstract:
      '今や Web システムのフロントエンドといえば SPA, SSR, SSG, ISR などのアーキテクチャをサポートするフレームワークを使用するのが当たり前になってきました。本セッションでは、フロントエンド開発をローカルからクラウドまでシームレスな開発体験を可能とする方法を Microsoft Azure のリソースである Azure Static Web Apps とその CLI と共にご紹介します。',
    speakers: [
      {
        id: 1417,
        name: 'Takashi Uesaka',
  ...
  },
  {
    ...
    videoPlatform: null,
    videoId:
      'https://d3pun3ptcv21q4.cloudfront.net/medialive/cndt2022/talks/1607/1607.m3u8',
    title: 'フロントエンド・オブザーバビリティ',
    abstract:
      'クラウドネイティブアーキテクチャにおいてオブザーバビリティが注目を集めています。KubernetesモニタリングやMicroservice APMなどがよく想像されるものですが、そこには重要なパーツが欠けています。それがフロントエンドモニタリングです。オブザーバビリティに組み込まれたモダンなフロントエンドモニタリングがEnd to Endの分析にどのように役に立つか、デモも交えてご紹介します。',
    speakers: [
      {
        id: 1423,
